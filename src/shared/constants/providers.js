...
export const APIKEY_PROVIDERS = {
  ...
  kira: { id: "kira", alias: "kira", name: "Kira AI", icon: "smart_toy", color: "#8B5CF6", textIcon: "KR", website: "https://kiraai.vn", notice: { text: "Kira AI - OpenAI-compatible API. Supports flash and pro models.", apiKeyUrl: "https://kiraai.vn/developer" }, serviceKinds: ["llm", "image", "video", "tts"], ttsConfig: { baseUrl: "https://kiraai.vn/api/v1/audio/speech", authType: "apikey", authHeader: "bearer", format: "openai", models: [{ id: "kira-2.5-flash", name: "Kira 2.5 Flash (TTS)" }], voices: [{ id: "Kore", name: "Kore" }, { id: "Fenrir", name: "Fenrir" }, { id: "Puck", name: "Puck" }, { id: "Charon", name: "Charon" }, { id: "Aoede", name: "Aoede" }] } },
