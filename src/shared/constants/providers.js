...
export const APIKEY_PROVIDERS = {
  ...
  kira: { id: "kira", alias: "kira", name: "Kira AI", icon: "smart_toy", color: "#8B5CF6", textIcon: "KR", website: "https://kiraai.vn", notice: { text: "Kira AI - OpenAI-compatible API. Supports flash and pro models.", apiKeyUrl: "https://kiraai.vn" }, serviceKinds: ["llm", "image", "video"] },
